function [ tau ] = taukl_fast( X, Y, correctionFlagOpt, dataSortedFlag, continuousIndicator )
...
%     tau = K/nchoosek(len,2);
    tau = K/(len*(len-1)/2); % same as nchoosek(len,2) but faster
    return;
end
