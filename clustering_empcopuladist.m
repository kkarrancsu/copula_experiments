...
if(ispc)
    load(sprintf('C:\\Users\\Kiran\\ownCloud\\PhD\\sim_results\\clustering\\regionDetection_cimv3_M_%d.mat', M));
elseif(ismac)
    load(sprintf('/Users/Kiran/ownCloud/PhD/sim_results/clustering/regionDetection_cimv3_M_%d.mat', M));
else
    load(sprintf('/home/kiran/ownCloud/PhD/sim_results/clustering/regionDetection_cimv3_M_%d.mat', M));
end
...
for M=MVec
    ...
    for l=noiseVec
        ...
        parfor mcSimNum=1:numMCSim
            ...
            t1 = t1 + abs(corr(x,y1,'type','kendall'));
            c1 = c1 + abs(corr(x,y1,'type','kendall'));
            c11 = c11 + cim_v4(x,y1,minscanincrVal);
            ...
            c2 = c2 + ( abs(corr(r1(:,1),r1(:,2),'type','kendall'))*0.5 + ...
                        abs(corr(r2(:,1),r2(:,2),'type','kendall'))*0.5 );
            c22 = c22 + cim_v4(x,y2,minscanincrVal);
            ...
            c3 = c3 + ( abs(corr(r1(:,1),r1(:,2),'type','kendall'))*0.1138 + ...
                        abs(corr(r2(:,1),r2(:,2),'type','kendall'))*0.4368 + ...
                        abs(corr(r3(:,1),r3(:,2),'type','kendall'))*0.4232);
            c33 = c33 + cim_v4(x,y3,minscanincrVal);
            ...
            c4 = c4 + ( abs(corr(r1(:,1),r1(:,2),'type','kendall'))*0.1138 + ...
                        ...
                        abs(corr(r4(:,1),r4(:,2),'type','kendall'))*0.2275 + ...
                        abs(corr(r5(:,1),r5(:,2),'type','kendall'))*0.1517);
            c44 = c44 + cim_v4(x,y4,minscanincrVal);
            ...
            c5 = c5 + ( abs(corr(r1(:,1),r1(:,2),'type','kendall'))*w1 + ...
                        ...
                        abs(corr(r16(:,1),r16(:,2),'type','kendall'))*w16 + ...
                        abs(corr(r17(:,1),r17(:,2),'type','kendall'))*w17);
            c55 = c55 + cim_v4(x,y5,minscanincrVal);
            
            t6 = t6 + abs(corr(x,y6,'type','kendall'));
            c6 = c6 + abs(corr(x,y6,'type','kendall'));
            c66 = c66 + cim_v4(x,y6,minscanincrVal);
            ...
            c7 = c7 + ( abs(corr(r1(:,1),r1(:,2),'type','kendall'))*0.25 + ...
                        ...
                        abs(corr(r3(:,1),r3(:,2),'type','kendall'))*0.25 + ...
                        abs(corr(r4(:,1),r4(:,2),'type','kendall'))*0.25);
            c77 = c77 + cim_v4(x,y7,minscanincrVal);
            
            t8 = t8 + abs(corr(x,y8,'type','kendall'));
            c8 = c8 + abs(corr(x,y8,'type','kendall'));
            c88 = c88 + cim_v4(x,y8,minscanincrVal);
            
            t9 = t9 + abs(corr(x,y9,'type','kendall'));
            c9 = c9 + abs(corr(x,y9,'type','kendall'));
            c99 = c99 + cim_v4(x,y9,minscanincrVal);
        end
        linearDep(1,l+1) = t1/numMCSim; linearDep(2,l+1) = c1/numMCSim; linearDep(3,l+1) = c11/numMCSim;
        quadraticDep(1,l+1) = t2/numMCSim; quadraticDep(2,l+1) = c2/numMCSim; quadraticDep(3,l+1) = c22/numMCSim;
        cubicDep(1,l+1) = t3/numMCSim; cubicDep(2,l+1) = c3/numMCSim; cubicDep(3,l+1) = c33/numMCSim;
    ...
    % save the data
    if(ispc)
        save(sprintf('C:\\Users\\Kiran\\ownCloud\\PhD\\sim_results\\clustering\\regionDetection_cimv4_MSISmall_M_%d.mat', M));
    elseif(ismac)
        save(sprintf('/Users/Kiran/ownCloud/PhD/sim_results/clustering/regionDetection_cimv4_MSISmall_M_%d.mat', M));
    else
        save(sprintf('/home/kiran/ownCloud/PhD/sim_results/clustering/regionDetection_cimv4_MSISmall_M_%d.mat', M));
    end
end
%% Plot the results
clear;
...
elseif(ismac)
    load(sprintf('/Users/Kiran/ownCloud/PhD/sim_results/clustering/regionDetection_cimv4_MSISmall_M_%d.mat', M));
else
    load(sprintf('/home/kiran/ownCloud/PhD/sim_results/clustering/regionDetection_cimv4_MSISmall_M_%d.mat', M));
end
...
grid on;
xlabel('noise');
legend('\tau','CIM Theoretical','CIMv4 Actual (sMSI)');
title('Linear Dependency');
hh1(1).LineWidth = 1.5; 
hh1(2).LineWidth = 1.5; 
hh1(3).LineWidth = 1.5; 
...
for M=MVec
    ...
    % save the data
    if(ispc)
        save(sprintf('C:\\Users\\Kiran\\ownCloud\\PhD\\sim_results\\clustering\\regionDetection_cimv4_M_%d.mat', M));
    elseif(ismac)
        save(sprintf('/Users/Kiran/ownCloud/PhD/sim_results/clustering/regionDetection_cimv4_M_%d.mat', M));
    else
        save(sprintf('/home/kiran/ownCloud/PhD/sim_results/clustering/regionDetection_cimv4_M_%d.mat', M));
    end
end
%% Plot the results
clear;
...
elseif(ismac)
    load(sprintf('/Users/Kiran/ownCloud/PhD/sim_results/clustering/regionDetection_cimv4_M_%d.mat', M));
else
    load(sprintf('/home/kiran/ownCloud/PhD/sim_results/clustering/regionDetection_cimv4_M_%d.mat', M));
end
...
grid on;
xlabel('noise');
legend('\tau','CIM Theoretical','CIMv4 Actual');
title('Linear Dependency');
hh1(1).LineWidth = 1.5; 
hh1(2).LineWidth = 1.5; 
hh1(3).LineWidth = 1.5; 
